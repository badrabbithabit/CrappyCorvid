...
- [x] GitHub Pages — repo made public, Pages enabled via **GitHub Actions** build mode (`build_type: workflow`), deploy workflow added at `.github/workflows/deploy-pages.yml`. **LIVE: https://badrabbithabit.github.io/CrappyCorvid/** (HTTP 200, verified)
